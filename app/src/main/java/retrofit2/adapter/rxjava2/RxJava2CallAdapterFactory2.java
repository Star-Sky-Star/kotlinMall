...
public final class RxJava2CallAdapterFactory2 extends CallAdapter.Factory {
  ...
  public static RxJava2CallAdapterFactory2 createWithSchedulers(Scheduler schedulerSubscribeOn, Scheduler schedulerObservableOn) {
    if (schedulerObservableOn == null) throw new NullPointerException("schedulerObservableOn == null");
    if (schedulerSubscribeOn == null) throw new NullPointerException("schedulerSubscribeOn == null");
    return new RxJava2CallAdapterFactory2( schedulerSubscribeOn,schedulerObservableOn,false);
  }

  private final @Nullable
  Scheduler schedulerSubscribeOn;
  private final @Nullable
  Scheduler schedulerObservableOn;
  private final boolean isAsync;

  private RxJava2CallAdapterFactory2(@Nullable Scheduler schedulerSubscribeOn, @Nullable Scheduler schedulerObservableOn, boolean isAsync) {
    this.schedulerSubscribeOn = schedulerSubscribeOn;
    this.schedulerObservableOn = schedulerObservableOn;
  ...
  @Override public @Nullable CallAdapter<?, ?> get(
    ...
    if (rawType == Completable.class) {
      ...
      return new RxJava2CallAdapter2(Void.class, schedulerSubscribeOn,schedulerObservableOn, isAsync, false, true, false, false,
          false, true);
    }
    ...
    return new RxJava2CallAdapter2(responseType, schedulerSubscribeOn,schedulerObservableOn, isAsync, isResult, isBody, isFlowable,
